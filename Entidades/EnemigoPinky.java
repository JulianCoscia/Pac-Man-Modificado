...
public class EnemigoPinky extends Enemigo {
	
	
	//falta metodo getEntidadGrafica, PersonajeGrafico no existe en el diagrama, que clase usamos?
	
	public EnemigoPinky(int posX,int posY,EntidadDinamicaGrafica miRepresentacion, Grilla grilla) {
		ancho = 32;
		alto = 32;
		this.posX = posX;
		this.posY = posY;
	...
	public void cambiarAHuir() {
		estado = new EstadoHuir(miGrilla, this, 32*18, 32*18);
